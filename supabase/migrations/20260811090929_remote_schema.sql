...
CREATE FUNCTION public.generer_code_invitation()
  RETURNS text
  LANGUAGE plpgsql
  AS $function$
declare
...
GRANT ALL ON FUNCTION public.generer_code_invitation() TO anon;

GRANT ALL ON FUNCTION public.generer_code_invitation() TO authenticated;

GRANT ALL ON FUNCTION public.generer_code_invitation() TO service_role;
...
ALTER TABLE public.joueurs
  ADD CONSTRAINT joueurs_code_invitation_key UNIQUE (code_invitation);
